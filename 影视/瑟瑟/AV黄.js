...
const SITE_API = process.env.SITE_API || "https://www.kxgav.com/api/json.php";
...
async function home(params) {
  try {
    ...
    // ====================== 手动写死全量分类 ======================
    const classes = [
      { type_id: "1", type_pid: "0", type_name: "全部" },
      { type_id: "2", type_pid: "0", type_name: "国产" },
      { type_id: "3", type_pid: "0", type_name: "日韩" },
      { type_id: "4", type_pid: "0", type_name: "欧美" },
      { type_id: "5", type_pid: "0", type_name: "动漫" },
      { type_id: "6", type_pid: "0", type_name: "综艺" },
      { type_id: "7", type_pid: "0", type_name: "电视剧" },
      { type_id: "8", type_pid: "0", type_name: "电影" },
      { type_id: "9", type_pid: "0", type_name: "纪录片" },
      { type_id: "10", type_pid: "0", type_name: "少儿" },
      { type_id: "11", type_pid: "0", type_name: "短剧" },
      { type_id: "12", type_pid: "0", type_name: "华语" },
      { type_id: "13", type_pid: "0", type_name: "港台" },
      { type_id: "14", type_pid: "0", type_name: "泰国" },
      { type_id: "15", type_pid: "0", type_name: "印度" },
      { type_id: "16", type_pid: "0", type_name: "动作" },
      { type_id: "17", type_pid: "0", type_name: "喜剧" },
      { type_id: "18", type_pid: "0", type_name: "爱情" },
      { type_id: "19", type_pid: "0", type_name: "科幻" },
      { type_id: "20", type_pid: "0", type_name: "恐怖" },
      { type_id: "21", type_pid: "0", type_name: "悬疑" },
      { type_id: "22", type_pid: "0", type_name: "战争" },
      { type_id: "23", type_pid: "0", type_name: "古装" },
      { type_id: "24", type_pid: "0", type_name: "军旅" },
      { type_id: "25", type_pid: "0", type_name: "家庭" },
      { type_id: "26", type_pid: "0", type_name: "都市" }
    ];
